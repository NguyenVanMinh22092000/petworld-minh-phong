...
insert into `petworld-v1`.service_packages ()
values (1, 'SP1', 'Img 1', true, 12.0, 5.3, 'Product 1', 'best seller'),
       (2, 'SP2', 'Img 2', true, 12.0, 5.3, 'Product 2', 'best seller'),
       (3, 'SP3', 'Img 3', true, 12.0, 5.3, 'Product 3', 'best seller');

insert into `petworld-v1`.services ()
values (1, 'S V 1', true, 'Sv 1', 4.2),
       (2, 'S V 2', true, 'Sv 2', 4.2),
       (3, 'S V 3', true, 'Sv 3', 4.2);

insert into `petworld-v1`.service_images()
values (1,"image.jng");

insert into `petworld-v1`.service_package_detail ()
values (1, 1), (1, 2) ;
insert into `petworld-v1`.service_image_detail ()
values (1, 1) ;